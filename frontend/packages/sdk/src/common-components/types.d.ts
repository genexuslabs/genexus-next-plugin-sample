import { Disposable, EventHandler, MaybePromise, AnyObject, CompositeDisposable, Emitter, Guid, IEquatable } from '../common' 
import { IUITypeEditorService, IUITypeEditorServiceDropDownOptions, ICustomTypeDescriptor, IPropertyDescriptor, TypeConverter, TypeDescriptorContext, UITypeEditor, PropertyValueChangedEventArgs, INotifyPropertyValueChanged, UITypeEditorEditStyle, IUIValidator } from '../common-properties' 
...
export declare class PropertyGrid extends EtchComponent {
    ...
    canResetProperty(propName: string): boolean;
    getSelectedProperty(): Promise<string | undefined>;
    getSelectedPropertyValue(): Promise<string | undefined>;
...
export declare class StructEditor extends EtchComponent {
    ...
    protected internalExecuteInsertKind(options: {
        kind: StructItemKind;
        position?: StructPosition;
        edit?: boolean;
    }): Promise<boolean>;
...
export declare type StyleLoaderCallback = () => MaybePromise<void>;
export declare class StyleLoader {
    private static _isBaseStyleLoaded;
    private static _pendingCallbacksQueue;
    static loadStyle(): void;
    static onBaseStyleLoaded(callback: () => void): void;
    private static _loadBaseStyle;
    private static _executePending;
    private static _loadBundles;
}
