...
import { Services } from '../language-comm-layer' 
import { EtchComponent, WindowForm } from '../common-components' 
import { CommandDescriptor, CommandExecHandler, CommandQueryHandler, GXDocumentPartEditor, IAutomatablePartEditor, ICommandsRegistry, IOutlinerItem, IOutlinerItemsDescriptor, IOutlinerSelectionResolver } from '../architecture-ui-framework' 
import { Disposable, MaybePromise, AnyObject, Guid } from '../common' 
import { TypeDescriptorContext, PropertyValueChangedEventArgs } from '../common-properties' 
import { KBObject, KBObjectPart, KBModel, RemotePropertiesObject } from '../architecture-common' 
...
export interface ISourceEditorCompletionProvidersRegistry {
    registerCompletionItemProvider(grammar: string, provider: ICompletionItemProvider): Disposable;
}
export declare const ISourceEditorCompletionProviderContribution: unique symbol;
export interface ISourceEditorCompletionProviderContribution {
    registerCompletionItemProviders(registry: ISourceEditorCompletionProvidersRegistry): void;
}
...
export declare class SourcePartEditor extends GXDocumentPartEditor {
    ...
    get completionItemProvider(): CompletionItemProvider;
    render(): JSX.Element;
    onDomReady(): void;
    onResize(): void;
    activate(): void;
    ...
    onDrop(text: string): Promise<void>;
    addTextToCurrentPosition(text: string): void;
...
export declare class MultiRegionSourcePartEditor extends GXDocumentPartEditor implements IOutlinerItemsDescriptor, IAutomatablePartEditor {
    private static _initializedLangs;
    private _isActive;
    ...
    private _onActivate;
    private _executeOnActivateQueue;
}
...
export interface ICompletionItemProvider extends monaco.languages.CompletionItemProvider, monaco.languages.InlineCompletionsProvider, monaco.languages.SignatureHelpProvider, monaco.languages.FoldingRangeProvider {
}
export declare class CompletionItemProvider implements ICompletionItemProvider {
    ...
    protected getChoices(model: monaco.editor.ITextModel, position: monaco.Position, token: monaco.CancellationToken): Promise<monaco.languages.CompletionList>;
    convertRemoteChoiceData(choiceList: IntellisenseChoiceList): monaco.languages.CompletionList;
    protected getRemoteChoiceList(model: monaco.editor.ITextModel, position: monaco.IPosition, token: monaco.CancellationToken, prefix?: string): Promise<IntellisenseChoiceList | undefined>;
