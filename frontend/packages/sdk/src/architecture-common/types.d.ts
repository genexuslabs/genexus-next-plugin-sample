import { IGXCommLayer, KBObjectData, KBObjectInfoData, EntityKeyData, KBContextData, KBModelData, KBObjectHeaderData, ResolveKeyResultData, ResolveResultData, EntityInfoData, EntityReferenceInfoData, KBModelPartData, KBObjectPartData, CreateKBOptionsData, KBInfoData, KBData, CommandListItemResultData, CommandListResultData, CommandResultData, PropertyData, AuthenticationProviderInfoData, AuthenticationSessionsChangedEventArgsData, ShareKBInfoData, GeneXusServerInfoData, KBObjectsHistoryInfoData, CommitInfoData, TeamDevUpdateItemData, UpdateInfoData, KBVersionData, KBVersionActivityRevisionData, KBVersionRevisionData, CheckLocalChanges, CheckRemoteChanges, TeamDevData, AccessTokenInfo, NewKBInfoData, TeamDevKBData, CreateKBResultData } from '../common-comm-layer' 
import { Services } from '../core-comm-layer' 
import { interfaces } from 'inversify' 
import { MaybePromise, Guid, Disposable, MaybeArray, AnyObject, CustomSymbolValueArgument, OutputMessages, CompositeDisposable, Emitter, OutputError, IOutputMessages } from '../common' 
import { IPropertyDescriptor, PropertyValueChangedEventArgs, PropertiesObjectData, PropertyValue, PropertiesObject, PropertyDefinitionCollection, PropertyManager, UITypeEditor, PropertyDefinition, TypeConverter, TypeDescriptorContext, IUIValidator, StringConverter } from '../common-properties' 
...
export declare namespace BLEvents {
    ...
    const AUTHENTICATION_PROVIDER_REGISTERED = "event://Authentication/ProviderRegistered";
    const AUTHENTICATION_PROVIDER_UNREGISTERED = "event://Authentication/ProviderUnregistered";
    const AUTHENTICATION_SESSIONS_CHANGED = "event://Authentication/SessionsChanged";
    const KB_CONTEXT_CHANGED = "event://KnowledgeBase/ContextChanged";
    const AFTER_IMPORT_ENTITY = "event://KnowledgeBase/AfterImportEntity";
}
...
export declare class GXCommLayer {
    ...
    static set(value: IGXCommLayer): void;
...
export declare class GXCommCoreServices {
    private static _instance;
    static get(): Services;
    static set(value: Services): void;
}
...
export declare class KBObjectDescriptor extends BaseDescriptor {
    ...
    get shortObjectClass(): number | undefined;
    get parts(): Guid[];
    ...
    static getByshortObjectClass(objClass: number): KBObjectDescriptor | undefined;
    static remove(id: Guid): boolean;
...
export declare type Config = AnyObject & {
    flags?: AnyObject;
};
export declare class ConfigHelper {
    private static _config;
    static initialize(value: Config): void;
...
export class KBProperties extends RemotePropertiesObject {
    private _kb;
    constructor(kb: KnowledgeBase);
    get kb(): KnowledgeBase;
    get model(): import("./kb-model").default;
    get remotePath(): string;
    get name(): string;
}
...
export declare const KB_NAME_PROPERTY = "Name";
export declare class KnowledgeBase {
    ...
    kbNameChanged(callback: () => MaybePromise<void>): Disposable;
    private _setTargetModel;
...
export declare type KBObjectTypeInfo = {
    id: Guid;
    name?: string;
};
...
export declare type RemoteEventArgsDeserializer = (kb: KnowledgeBase | undefined, args: string | AnyObject) => any;
export declare class RemoteEventArgsDeserializers {
    static registerRemoteEvent(name: string, deserializer: RemoteEventArgsDeserializer): void;
    static get(name: string): RemoteEventArgsDeserializer | undefined;
}
...
export declare class CommonServices {
    static authentication: IAuthenticationService;
...
export interface IAuthenticationService {
    getProviders(): MaybePromise<AuthenticationProviderInfo[]>;
    getProvider(id: string): MaybePromise<AuthenticationProviderInfo | undefined>;
    removeSession(providerId: string, sessionId: string): MaybePromise<void>;
    removeAllSessions(providerId: string): MaybePromise<void>;
    sessionsChanged(callback: AuthenticationSessionsChangedEventHandler): Disposable;
}
export declare type AuthenticationProviderInfo = AuthenticationProviderInfoData;
export declare type AuthenticationSessionsChangedEventArgs = AuthenticationSessionsChangedEventArgsData;
export declare type AuthenticationSessionsChangedEventHandler = (args: AuthenticationSessionsChangedEventArgs) => void;
