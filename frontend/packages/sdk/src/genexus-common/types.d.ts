import { KBModel, KBModelPart, RemotePropertiesObject, KBObject, KBObjectInfo, EntityKey, RemotePropertyManager, StructPart, StructPartItem, StructPartItemOptions, KBObjectPart, RemoteCommandData, KBObjectPartCommand, KBObjectPartElement } from '../architecture-common' 
import { DataStoreData, DeploymentUnitData, GeneratorData, DesignSystemReferences } from '../genexus-comm-layer' 
import { ComparableProperties, IComparableModelPart } from '../architecture-ui-framework' 
import { Guid, MaybePromise } from '../common' 
import { KBObjectData, EntityKeyData, KeyValueData, KBObjectPartData, CommandResultData } from '../common-comm-layer' 
import { PropertiesObjectData, PropertyManager, CustomTypeDescriptorInfo, IPropertyDescriptor, PropertiesObject } from '../common-properties' 
import { ResolveValueResult, ISourceRegionPart, ResolveValueData, SourcePart, MultiRegionSourcePart } from '../language-common' 
import { PatternInstance, PatternInstanceElement, PatternInstancePart } from '../patterns-common' 
import { UploadedFile } from '../common-components' 
...
export declare namespace Commands {
    ...
    const RUN_OBJECT_WITHOUT_BUILDING: {
        id: string;
        label: string;
    };
...
export declare namespace ReportLayoutEditorCommands {
    const ADD_PRINT_BLOCK: {
        id: string;
        label: string;
    };
}
export declare namespace DataModelDiagramEditorCommands {
    const ADD_ALL_REFERENCES: {
        id: string;
        label: string;
    };
    const ADD_ALL_RELATED: {
        id: string;
        label: string;
    };
    const ADD_ALL_SUB_MODULES: {
        id: string;
        label: string;
    };
    const ADD_ALL_SUBORDINATED: {
        id: string;
        label: string;
    };
    const ADD_ALL_SUPERORDINATED: {
        id: string;
        label: string;
    };
    const ADD_EXTENDED: {
    ...
    const ADD_SUB_MODULES: {
        id: string;
        label: string;
    };
    const ADD_SUBORDINATED: {
        id: string;
        label: string;
    };
    const ADD_SUPERORDINATED: {
        id: string;
        label: string;
    };
    const ARRANGE_NODES: {
...
export declare namespace DataViewObjectCommands {
    namespace Common {
        const ADD_ATTRIBUTE: {
            id: string;
            label: string;
...
export declare namespace DataModelDiagramEditorMenus {
    const ADD_RELATED_NODES_GROUP: string[];
}
export declare namespace ReportLayoutEditorMenus {
    const ADD_PRINT_BLOCK: string[];
}
...
export declare namespace DataViewObjectMenus {
    const INDEXES: string[];
    const STRUCTURE: string[];
}
...
export declare class DataStoresHelper {
    private static _dataStores?;
    static getDataStoreNames(prefix: string): Promise<string[]>;
    static isValidDataStore(name: string): Promise<boolean>;
    static getDataStoreDbms(name: string): Promise<number | undefined>;
    private static getDataStore;
    private static getAvailableDataStores;
    private static _fetchAvailableDataStores;
}
...
export declare class Agent extends KBObject {
    constructor(model: KBModel);
}
...
export declare class DataModelDiagram extends KBObject {
    constructor(model: KBModel);
}
...
export declare class DataView extends KBObject {
    constructor(model: KBModel);
}
...
export declare class Document extends KBObject {
    constructor(model: KBModel);
}
...
export declare class GXObjectClasses {
    ...
    static get DATA_VIEW(): Guid;
    static get DEPLOYMENT_UNIT(): Guid;
    static get DESIGN_SYSTEM(): Guid;
    static get DIAGRAM(): Guid;
    static get DOCUMENT(): Guid;
...
export declare class DataModelDiagramPart extends DiagramPart {
    constructor(object: KBObject);
    createElement(parentSlot?: DiagramElementSlot | undefined): DiagramElement;
    insertElement(element: DiagramElement, index?: number | undefined, notifyChildren?: boolean | undefined): void;
    addRelated(ids: Guid[]): Promise<DataModelDiagramElement[]>;
    addAllRelated(ids: Guid[]): Promise<DataModelDiagramElement[]>;
    addAllReferences(ids: Guid[]): Promise<DataModelDiagramElement[]>;
    AddASubModules(ids: Guid[]): Promise<DataModelDiagramElement[]>;
    AddAllSubModules(ids: Guid[]): Promise<DataModelDiagramElement[]>;
    AddSubordinated(ids: Guid[]): Promise<DataModelDiagramElement[]>;
    AddAllSubordinated(ids: Guid[]): Promise<DataModelDiagramElement[]>;
    AddSuperordinated(ids: Guid[]): Promise<DataModelDiagramElement[]>;
    AddAllSuperordinated(ids: Guid[]): Promise<DataModelDiagramElement[]>;
    AddExtended(ids: Guid[]): Promise<DataModelDiagramElement[]>;
    addKBObjectNodesAtPosition(keys: EntityKey[], position: PointData): Promise<DataModelDiagramElement[]>;
    addRelatedNodes(ids: Guid[], relationshipType: RelationshipType): Promise<DataModelDiagramElement[]>;
    private _executeDataModelCommand;
}
export declare class DataModelDiagramElement extends DiagramElement {
    private _dataModelProperties;
    get dataModelProperties(): DataModelElementProperties;
...
export declare type AddKBObjectNodesAtPositionCommandData = {
    objectKeys: EntityKeyData[];
    position: PointData;
};
export declare type AddRelatedNodesCommandData = {
    ids: string[];
...
export declare enum RelationshipType {
    ...
    AllSubordinated = "AllSubordinated",
    AllSuperordinated = "AllSuperordinated",
    Extended = "Extended",
    References = "References",
    Related = "Related",
    SubModules = "SubModules",
    Subordinated = "Subordinated",
    Superordinated = "Superordinated"
}
export declare type DataModelElementData = DiagramElementData & {
    readonly dataModelProperties: DataModelElementProperties;
};
export declare type DataModelElementProperties = {
    readonly name: string;
    readonly objectGuid: string;
    readonly connectionType: DataModelConnectionType;
    readonly rootLevel: DataModelElementItem;
};
export declare type DataModelElementItem = {
    readonly name: string;
    readonly children?: DataModelElementItem[];
    readonly type: DataModelItemType;
};
export declare enum DataModelElementType {
    Module = "Module",
    Transaction = "Transaction",
    Table = "Table",
    Connector = "Connector"
}
export declare enum DataModelItemType {
    Key = "Key",
    Attribute = "Attribute",
    Level = "Level"
}
export declare enum DataModelConnectionType {
    None = "None",
    OneToOne = "OneToOne",
    OneToMany = "OneToMany",
    ManyToOne = "ManyToOne",
    ...
    ReferenceDoubleChild = "ReferenceDoubleChild"
}

declare class DataViewPropertyManager extends RemotePropertyManager {
    constructor(item: StructPartItem);
}
declare class DataViewPartItem extends StructPartItem {
    constructor(part: StructPart, type: string, guid?: Guid, parent?: StructPartItem);
    cacheProperties(): Promise<void>;
}
declare class DataViewPlatformPropertyManager extends DataViewPropertyManager {
    platform: string;
    constructor(item: StructPartItem);
    deserializeProperties(data: PropertiesObjectData): Promise<void>;
}
export declare class DataViewAttPropertyManager extends DataViewPropertyManager {
    attribute: string;
    constructor(item: StructPartItem);
    deserializeProperties(data: PropertiesObjectData): Promise<void>;
    processField(field: KeyValueData): void;
}
export declare class DataViewAttributePartItem extends DataViewPartItem {
    constructor(part: StructPart, type: string, guid?: Guid, parent?: StructPartItem);
    get attribute(): string;
    set attribute(value: string);
    get attributeManager(): DataViewAttPropertyManager;
    createPropertyManager(): PropertyManager;
}
export declare class DataViewPlatformPartItem extends DataViewPartItem {
    constructor(part: StructPart, guid?: Guid, parent?: StructPartItem);
    get platform(): string;
    set platform(value: string);
    protected get _platformManager(): DataViewPlatformPropertyManager;
    createPropertyManager(): PropertyManager;
}
export {};

export declare class DataViewMemberPropertyManager extends DataViewAttPropertyManager {
    order: string;
    constructor(item: StructPartItem);
    processField(field: KeyValueData): void;
}
export declare class DataViewIndexesMemberPartItem extends DataViewAttributePartItem {
    constructor(part: DataViewStructurePart, guid?: Guid, parent?: StructPartItem);
    get attributeManager(): DataViewMemberPropertyManager;
    get order(): string;
    set order(value: string);
    createPropertyManager(): PropertyManager;
}

export declare class DataViewStructureAttPropertyManager extends DataViewAttPropertyManager {
    formula: string;
    constructor(item: StructPartItem);
    processField(field: KeyValueData): void;
}
export declare class DataViewStructureAttributePartItem extends DataViewAttributePartItem {
    constructor(part: DataViewStructurePart, guid?: Guid, parent?: StructPartItem);
    get attributeManager(): DataViewStructureAttPropertyManager;
    get formula(): string;
    createPropertyManager(): PropertyManager;
}

export declare namespace DataViewTypes {
    namespace Common {
    ...
    namespace Structure {
        const DATA_VIEW_ATTRIBUTE = "DataViewAttribute";
    }
}

export declare class DataViewIndexesPart extends DataViewPart {
    constructor(kbObject: KBObject);
    createItem(options: StructPartItemOptions): StructPartItem;
}

export declare class DataViewStructurePart extends DataViewPart {
    constructor(kbObject: KBObject);
    createItem(options: StructPartItemOptions): StructPartItem;
}
...
export declare class DiagramPart extends KBObjectPart {
    ...
    createElement(parentSlot?: DiagramElementSlot): DiagramElement;
}

export declare class DocumentationPart extends SourcePart {
    constructor(kbObject: KBObject);
}
...
export declare namespace GXCategoryClasses {
    const ARTIFICIAL_INTELLIGENCE: Guid;
...
export declare class GXPartClasses {
    ...
    static get DATA_VIEW_INDEXES_PART(): Guid;
    static get DATA_VIEW_STRUCTURE_PART(): Guid;
    ...
    static get DIAGRAM(): Guid;
    static get DOCUMENTATION_PART(): Guid;
