import { Guid, MaybePromise, AnyObject, Disposable } from '../common' 
import { KBObjectInfo, KBObject, KBObjectPart, KBModel, KBObjectPartElement, RemoteCommandData, KBObjectPartCommand, KBObjectPartCompositeCommand, IKBObject, KBObjectDescriptor } from '../architecture-common' 
import { BaseEditor, GXDocumentPartEditor, CommandData, CommandState, ICommandsRegistry, IMenuRegistry } from '../architecture-ui-framework' 
import { EditorCommand, EditorCommandManager, UndoRedoEventArgs, TreeItem } from '../common-components' 
import { KBObjectData, CommandListResultData, CommandResultData, KBObjectPartData } from '../common-comm-layer' 
import { PropertiesObjectData, PropertyValueChangedEventArgs } from '../common-properties' 
import { PatternDefinitionData, PatternSpecificationAttributeData, PatternSpecificationChildData, PatternSpecificationRootData, PatternSpecificationTypeData, SpecificationTypeInitializationData } from '../genexus-comm-layer' 
