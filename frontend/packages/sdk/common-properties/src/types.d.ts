import { MaybePromise, Emitter, CompositeDisposable, AnyObject, Disposable, IDisposable } from '@genexusm-sdk/common' 
...
export class PropertiesObject implements ICustomTypeDescriptor, INotifyPropertyValueChanged {
    ...
    getPropertydefinition(): Promise<PropertyDefinition[]>;
